...
/**
 * Provides the local service interface for MonthlyTrading. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MonthlyTradingLocalServiceUtil
...
public interface MonthlyTradingLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MonthlyTradingLocalServiceUtil} to access the monthly trading local service. Add custom service methods to {@link monthly.trading.service.impl.MonthlyTradingLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MonthlyTrading fetchMonthlyTradingByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MonthlyTrading getMonthlyTradingByUuidAndGroupId(
